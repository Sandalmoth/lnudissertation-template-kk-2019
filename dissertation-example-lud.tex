...
%% Used for list of abbreviations and abbreviations in general
\usepackage{acro}
...
%% Include abbreviation definitions
\input{glossary}
...
\input{abstract} % This abstract is replaced by LUD, but is included for writing convenience
\input{dedication}
\frontmatter
\input{popsci-abstract} % Secondary popular science abstract in swedish
...
%$ Lists of figures and tables are not typically present for compilation thesis
%\phantomsection
...
\input{acknowledgments} % acknowledgements last
\cleardoublepage
